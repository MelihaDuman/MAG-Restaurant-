...
<c:choose>
    <c:when test="${model!=null}">
        ...
        <form method="POST" action="<c:url value="/store/update/"/>">
            <input type="hidden" id="original_name" name="original_name" value="${store.name}"/>
    ...
    <c:otherwise>
        ...
        <form method="POST" action="<c:url value="/store/insert/"/>">
